...
import {
  ApolloProvider,
  VueApolloComponent,
} from 'vue-apollo/types/apollo-provider';
...
export interface DollarApollo<V> {
  ...
  mutate<R = any>(
    options: VueApolloMutationOptions<V, R>
  ): Promise<QueryResult<R>>;
  subscribe<R = any>(
    options: VueApolloSubscriptionOptions<V, R>
  ): Observable<R>;
...
export function willPrefetch(
  component: VueApolloComponent,
  contextCallback?: boolean
): VueApolloComponent;
